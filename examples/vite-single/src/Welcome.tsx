...
const stack = ['Single package', 'Vitest', 'Istanbul', 'Playwright'];
  ...
  return (
    <PageLayout background="#f5f5ff" testID="welcome-page">
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <Monogram letter="S" color={accent} />
        <Text
          tag="h1"
          size="xxl"
          weight="bold"
        ...
        >
          Welcome to the Single-Package App
        </Text>
        <Text
          tag="p"
          size="base"
        ...
        >
          Unit + E2E coverage, fused into one report
        </Text>
