...
// The example root (examples/vite-mono). Coverage keys are relative to it so they
...
// (e.g. /Users/you/test-fusion/examples/vite-mono/ui/src/Badge.tsx), while this
// reporter runs with a Docker cwd (/app/examples/vite-mono) that can't strip them.
